...
; nasm -f elf64 pedromiottomujica.asm ; ld pedromiottomujica.o -o pedromiottomujica.x

; Para verificar os resultados no gdb
; run
; b fim
; x/g &resultado
...
section .data
    ...
    strLFL : equ 1
    erroMsg: db "Cabeça de Automato, deu overflow!!!!!", 10
